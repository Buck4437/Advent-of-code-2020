...
public class Question02 {
    ...
    final private static String input = "1-4 m: mrfmmbjxr\n" +
    ...
    final private static String[] passwordList = input.split("\n");

    public static void main(String[] args){
        //part 1 + 2, new
        int valid1 = 0, valid2 = 0;
        for (String passwordPolicy : passwordList){
            Question02Password password = new Question02Password(passwordPolicy);
