...
public class Question07 {
    ...
    static String[] rules = input.replace("bags", "bag")
            .split("\n");
    ...
    public static void main(String[] args){
        ...
        //part 2
        System.out.println(countTotalBags("shiny gold bag") - 1); //to exclude shiny gold bag itself
    }

    public static void findParentBags(String bagName){
        for (String rule : rules){
            ...
            if (parentChildBag[1].contains(bagName)){
                ...
                findParentBags(parentName);
            }
        }
    }

    public static int countTotalBags(String parentBagName){
        int bags = 1; //itself
        ...
        for (String rule : rules){
            ...
            if (bagRules[0].contains(parentBagName)){
                ...
                for (String childBagParam : childBags){
                    ...
                    bags += numberOfChildBags * countTotalBags(childBagName);
                }
                return bags;
            }
        }
