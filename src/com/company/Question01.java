...
public class Question01 {
    ...
    public static void main(String[] args) {
        ...
        String[] listOfNumString = input.split("\n");
        ArrayList<Integer> listOfNum = new ArrayList<>();
        for (String str : listOfNumString){
            listOfNum.add(Integer.parseInt(str));
        }

        //part 1
        for (int num : listOfNum){
            if (listOfNum.contains(2020 - num)){
        ...
        for (int num1 : listOfNum){
            for (int num2 : listOfNum) {
                if (listOfNum.contains(2020 - num1 - num2)){
