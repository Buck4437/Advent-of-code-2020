...
public class Puzzle2 {
    ...
    public Puzzle2(int id, String puzzle) {
        this.id = id;
        this.puzzle = puzzle;
    ...
    public Puzzle2 rotate() { //Clockwise
    ...
    public Puzzle2 flip() { //Horizontally
        ArrayList<String> nPuzzle = new ArrayList<>();
        for (String row : puzzle.split("\n")) {
            String nRow = "";
    ...
    public boolean canFit(Puzzle2 puzzle2) {
        return canFitWhere(puzzle2) != NONE;
    }

    public int canFitWhere(Puzzle2 puzzle2) {
